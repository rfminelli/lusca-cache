...
extern auth_acl_t authenticateTryToAuthenticateAndSetAuthUser(auth_user_request_t **, http_hdr_type, request_t *, ConnStateData *, sqaddr_t *);
...
extern void authenticateAuthUserRequestRemoveIp(auth_user_request_t *, sqaddr_t *);
